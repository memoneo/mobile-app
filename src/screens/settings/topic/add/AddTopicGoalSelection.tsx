...
const AddTopicGoalSelectionSchema = Yup.object().shape({
  name: Yup.string().min(1).max(64).required("Name is required"),
  optional: Yup.boolean(),
})

function AddTopicGoalSelection(props: Props): JSX.Element {
  return (
    <Formik<FormValues>
      initialValues={{
        name: "",
      ...
      validationSchema={AddTopicGoalSelectionSchema}
    >
      {(formikProps) => {
...
export default AddTopicGoalSelection
